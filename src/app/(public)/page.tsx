  ...
  return (
    <>
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center text-center px-4 pt-16 pb-12 overflow-hidden">
        ...
        <p className="text-lg md:text-xl text-white/70 max-w-xl mb-8 font-light">Premium short-term apartments in Las Americas &amp; Los Cristianos. Your home away from home in paradise.</p>
        ...
        <div className="flex flex-wrap gap-4 justify-center">
          ...
          <a href="#apartments" className="btn btn-outline btn-lg">
            Browse Apartments
          </a>
        </div>
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              {aboutBody ? (
                ...
                <>
                  <p className="text-navy/70 mb-4">
                    Sayzora Hospitality curates a collection of hand-picked apartments across Tenerife's most sought-after coastal areas. Each property is fully equipped, professionally managed, and designed to make you
              ...
              <div className="mt-8">
                <a href={BOOKING_URL} target="_blank" rel="noopener noreferrer" className="btn btn-primary btn-md">
                  Check Availability →
                </a>
              </div>
            </div>
      ...
      <section id="apartments" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          ...
          {apartments.length === 0 && <p className="text-center text-navy/50 py-12">No apartments found. Add some in the admin panel.</p>}
            ...
            <div>
              ...
              {[
                ...
                <div key={label as string} className="flex items-center gap-3 mb-4">
                  ...
                  {href ? (
                    <a href={href as string} target={href?.startsWith("http") ? "_blank" : undefined} rel="noopener noreferrer" className="text-blue hover:underline text-sm">
                      {label}
                    </a>
                  ) : (
