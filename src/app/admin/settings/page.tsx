    ...
    <AdminShell>
      <div className="p-8 max-w-xl">
        ...
        <div className="mt-6 bg-amber-50 border border-amber-200 rounded-2xl p-5">
          ...
          <p className="text-xs text-amber-700">Edit <code className="bg-amber-100 px-1 rounded">.env.local</code> and update <code className="bg-amber-100 px-1 rounded">ADMIN_USERNAME</code> and <code className="bg-amber-100 px-1 rounded">ADMIN_PASSWORD</code>, then restart the server.</p>
        </div>
      </div>
    </AdminShell>
  );
