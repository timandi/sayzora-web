      ...
      <div className="p-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-10">
          {[
            ...
            <Link key={s.label} href={s.href} target={s.href.startsWith("http") ? "_blank" : undefined} className="bg-white rounded-2xl p-5 border border-blue/10 shadow-sm hover:shadow-md transition-shadow">
        ...
        <div className="grid md:grid-cols-3 gap-4">
          {[
            ...
            <Link key={c.title} href={c.href} className="bg-white rounded-2xl p-6 border border-blue/10 shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all">
